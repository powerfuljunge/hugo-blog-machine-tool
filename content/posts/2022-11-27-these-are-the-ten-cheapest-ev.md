...
## 最安EVとは言っても3万ユーロ前後 {.wp-block-heading}

記事のリンクを見ると、クルマの写真とともにモデル名と金額が載っています  
ランキングをまとめると以下のようです<figure class="wp-block-table is-style-stripes">
...
## 電気自動車の財布に厳しい現実 {.wp-block-heading}
...
## 電気自動車に期待される量産効果 {.wp-block-heading}
...
## 中国メーカは電気自動車でドイツ市場を攻略できるか？ {.wp-block-heading}
